...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, patience, checkpoint_interval):
    best_model_wts = None
    best_iou = 0.0
    epochs_no_improve = 0
    device = model.device
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            with tqdm(total=len(data_loader), desc=f'{phase.capitalize()} Epoch {epoch + 1}', unit='batch') as pbar:
